...
import MapLeafletComp4 from '../components/mapLeafletComp4';
...
class MapLeaflet4 extends Component {
    render() {
        return (
            <div>
                ...
                <div>
                    <div className="IndexOma">
                        ...
                        <li><Link to="/mapLeaflet4"> XX Map (Leaflet core/library, Leaflet Map#4, Open Street Maps) (Tämä sivu) </Link></li>
