...
import MapLeafletComp2 from '../components/mapLeafletComp2';
...
class MapLeaflet2 extends Component {
    render() {
        return (
            <div>
                ...
                <div>
                    <div className="IndexOma">
                        ...
                        <br />
                        <br />
                        Tämä on mapLeaflet2.jsx (Leaflet library, Mapbox Map). Enjoy. 
                        <br />
                        <br />
                        <MapLeafletComp2 /> 
                        <Spacekomponentti />
                        ...
                        <li><Link to="/mapLeaflet2"> Southern Finland, Sat Map  (Leaflet core/library, Leaflet Map#2) (Tämä sivu)  </Link></li>
