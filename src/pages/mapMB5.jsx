...
import MapMBComp5 from '../components/mapMBComp5';
...
export default class MapMB5 extends Component {
    render() {
        return (
            <div>
                ...
                <div>
                    <div className="IndexOma">
                        ...
                        <br />
                        <br />
                        Tämä on mapMB5.jsx (Mapbox Map, different map styles etc). Enjoy. 
                        <br />
                        <br />
                        <MapMBComp5 /> 
                        <Spacekomponentti />
                        ...
                        <li><Link to="/mapMB5"> Southern Finland, Sat Map (Leaflet core, Mapbox Map#5, different map styles etc)  (Tämä sivu) </Link></li>
