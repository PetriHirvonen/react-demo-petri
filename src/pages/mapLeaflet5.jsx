...
import MapLeafletComp5 from '../components/mapLeafletComp5';
...
class MapLeaflet5 extends Component {
    render() {
        return (
            <div>
                ...
                <div>
                    <div className="IndexOma">
                        ...
                        <br />
                        <br />
                        Tämä on mapLeaflet5.jsx (Leaflet library, Mapbox Map). Enjoy. 
                        <br />
                        <br />
                        <MapLeafletComp5 /> 
                        <Spacekomponentti />
                        ...
                        <li><Link to="/mapLeaflet5"> XX Map (Leaflet core/library, Leaflet Map#5, Open Street Maps) (Tämä sivu) </Link></li>
